...
class bannerDTViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func loadData(){
        ...
        goodsListModel.requstLingShiDataModel(String(1)) { (dataArr, specialArr, error) in
            if error == nil {
    ...
    func createUI(){
        ...
        let label = UILabel.init(frame: CGRectMake(20, 250, SCREEN_W - 40, 100))
