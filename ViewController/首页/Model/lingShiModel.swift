...
extension goodsListModel{
    ...
    class func requstLingShiDataModel(page:String,callBack:(dataArr:NSMutableArray?,specialArr:NSMutableArray?,error:NSError?)->Void){
        
        
        BaseRequest.getWithURL("http://interface.yueshichina.com/?act=app&op=goods_special&special_id=375&key=efbd1b3105a02ff790b706f66ced4cfc&token=749a036dc06ae8b3a120848995a9f306&client=android&curpage=1", para: nil) { (data, error) in
